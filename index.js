...
/////////////////
const BotName = 'MJD BOT☄'; 
const instagram = 'https://instagram.com/mici.379'; 
const telegram = 'https://t.me/Mici379'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtube.com/channel/UCtrgbMqDxqcE5mG4HaWwXkQ';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@mici.379')
